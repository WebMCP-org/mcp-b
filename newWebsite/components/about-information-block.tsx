  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
      {useCases.map((useCase, index) => (
        ...
        >
          <div className="relative z-10 h-full border border-gray-200 bg-gray-50 p-4 transition duration-200 hover:border-brand hover:bg-neutral-50 md:p-5 dark:border-white/10 dark:bg-zinc-950/40 dark:hover:border-brand dark:hover:bg-zinc-950/60">
