  ...
  return (
    <section className="">
      <Container className="border-divide flex flex-col items-center justify-center border-x pt-10 pb-10">
        ...
        <div className="relative mt-8 flex items-center gap-4 rounded-xl border border-gray-200 bg-white/60 backdrop-blur-sm p-2 dark:border-white/10 dark:bg-zinc-950/40">
