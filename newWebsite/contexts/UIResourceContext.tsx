...
/**
 * Type representing a UI embedded resource
 * For now, this is a simplified version - can be extended with actual UIResourceRenderer type
 */
export type UIEmbeddedResource = {
  uri: string;
  mimeType?: string;
  blob?: string;
  [key: string]: unknown;
