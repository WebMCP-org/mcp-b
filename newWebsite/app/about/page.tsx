            ...
            <div className="mt-6 flex flex-col gap-3">
              <div className="relative rounded-lg border p-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="relative z-10 block border border-neutral-200 p-4 transition-colors hover:border-brand hover:bg-neutral-50 dark:border-neutral-800 dark:hover:border-brand dark:hover:bg-neutral-800/50"
                >
          ...
          <div className="mt-12 grid w-full grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <div className="relative rounded-2xl border p-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="relative z-10 block group border border-neutral-200 p-6 transition-all hover:border-brand hover:bg-neutral-50 dark:border-neutral-800 dark:hover:border-brand dark:hover:bg-neutral-800/50"
              >
