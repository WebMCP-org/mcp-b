...
tags: ["mcp", "browser", "security", "architecture", "web-development"]
featured: true
draft: false
---
...
<BlogImage src="/images/blog/smaller.gif" alt="MCP-B Demo" variant="light-bg" />

This means your website can be an MCP server and/or client and so can your browser extension.

## How MCP-B Works

<BlogImage src="/images/blog/full-arch.png" alt="MCP-B Full Architecture" variant="light-bg" />
...
<BlogImage src="/images/blog/multi-site-workflow.svg" alt="Multi-Site Workflow Diagram" variant="light-bg" />
...
<BlogImage src="/images/blog/dynamic-tool-caching.gif" alt="Tool Caching Demo" variant="light-bg" />
