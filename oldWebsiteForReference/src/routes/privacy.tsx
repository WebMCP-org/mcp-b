...
export const Route = createFileRoute('/privacy')({
  meta: () => [
    { title: 'Privacy Policy - MCP-B' },
    {
      name: 'description',
      content:
        'MCP-B Privacy Policy - Learn how we protect your data and privacy when using our browser extension and web application.',
    },
    {
      name: 'keywords',
      content:
        'MCP-B privacy policy, data protection, browser extension privacy, user data security',
    },
    { name: 'robots', content: 'index,follow' },
    { property: 'og:type', content: 'website' },
    { property: 'og:title', content: 'Privacy Policy - MCP-B' },
    {
      property: 'og:description',
      content:
        'Learn how we protect your data and privacy when using our browser extension and web application.',
    },
    { property: 'og:image', content: '/vite.svg' },
    { name: 'twitter:card', content: 'summary' },
    { name: 'twitter:title', content: 'Privacy Policy - MCP-B' },
    {
