...
export const Route = createFileRoute('/assistant')({
  meta: () => [
    { title: 'AI Assistant - MCP-B' },
    {
      name: 'description',
      content:
        'Interact with AI models using the Model Context Protocol in your browser. Experience seamless AI automation with MCP-B.',
    },
    {
      name: 'keywords',
      content:
        'AI Assistant, MCP-B, Model Context Protocol, Browser AI, AI Automation, Chat Interface',
    },
    { name: 'robots', content: 'index,follow' },
    { property: 'og:type', content: 'website' },
    { property: 'og:title', content: 'AI Assistant - MCP-B' },
    {
      property: 'og:description',
      content: 'Interact with AI models using the Model Context Protocol in your browser.',
    },
    { property: 'og:image', content: '/vite.svg' },
    { name: 'twitter:card', content: 'summary_large_image' },
    { name: 'twitter:title', content: 'AI Assistant - MCP-B' },
    {
